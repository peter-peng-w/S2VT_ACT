...
def parse_opt():
    ...
    parser.add_argument(
        '--input_json',
        type=str,
        default='data/MSR-VTT/Train_Val_Annotation/train_val_videodatainfo.json.json',
    ...
    parser.add_argument(
        '--log_dir', type=str, default='./logging', help='The path of the logging dir'
    )
