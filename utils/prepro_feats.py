...
# This parameter follows the input size of the selected model
C, H, W = 3, 224, 224
...
def extract_feats(params, model, load_image_fn):
    ...
    model.eval()
    # Load the directory location where the featuremaps are being saved
    ...
    for video in tqdm(video_list):
        ...
        # Extract images(frames) from videos
        image_list = sorted(glob.glob(os.path.join(dst, '*.jpg')))
        # Linearly sample a bunch of frames
